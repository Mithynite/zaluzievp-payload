...
export interface Config {
  ...
  globalsSelect: {
    topNavigation: TopNavigationSelect<false> | TopNavigationSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "topNavigation".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "topNavigation_select".
 */
export interface TopNavigationSelect<T extends boolean = true> {
  contacts?:
    | T
    | {
        value?: T;
